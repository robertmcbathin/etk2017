...
@endsection
@section('title')
Ошибка! Средства не были списаны
@endsection
@section('content')
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-8 col-md-offset-2">
          <h4 class="title">Результат пополнения</h4>
          <p class="description">
          ...
          <div class="row">
            <div class="col-md-4 col-sm-12">
              ...
              <div class="col-md-8 col-sm-12 col-md-offset-2">
                <h2 class="title">Что-то пошло не так. Средства не были списаны. Обратитесь к нам в рабочее время по телефону</h2>
            </div>

                  ...
                  <div class="row">
                    <div class="col-xs-12 col-md-3">
                      <div class="card-image ">
                        <img class="img img-raised" width="" src="/pictures/cards/thumbnails/160/{{$card->card_image_type}}.png">
          ...
          @if(Auth::user()->birthdate == null)
           <div class="card">
            <div class="card-content content-info">
              <h4 class="card-title">
                <b>Обновление:</b> Укажите пол и возраст в настройках для более точной идентификации Вас при обращении к нам в офис
              </h4>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h6>Для подтверждения владения картой Вам необходимо ввести <strong>8 символов</strong> чипа карты</h6>
        <small class="description"><b>Узнать номер чипа Вы можете при помощи чека о пополнении (на почте, в наших офисах или отделениях Чувашкредитпромбанка), а также мобильного телефона с функцией NFC. (Необходимо скачать приложение для чтения Mifare карт. Например, NFC Tools. Номер чипа будет указан в поле Серийный номер при прикладывании карты к телефону. Владельцам iPhone данный вариант не подходит.)</b></small>
      </div>

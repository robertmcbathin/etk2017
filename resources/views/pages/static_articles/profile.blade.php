        ...
        <div class="container">
          ...
          <div class="row">
            <div class="col-md-8 col-md-offset-2">
                        ...
                        <br>
                        <img class="img-rounded img-responsive img-raised" alt="Raised Image" src="/pictures/static_articles/profile/profile.jpg">
                        <br>
                        <p>Сейчас Вы можете добавить карту, узнать баланс, дату последней транзакции, состояние карты.</p>
                        <p>После подтверждения карты (необходимо ввести 8 цифр чипа карты) Вы сможете увидеть отчет по поездкам за месяц, заказать детализацию по поездкам, а также просмотреть историю пополнения в терминалах Сбербанка и поставить карту в очерердь на блокировку.</p>

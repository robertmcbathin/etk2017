            ...
            <div class="card">
              ...
              <div class="card-content table-responsive">
                <div class="form-group">
                 <form action="{{ route('sudo.pages.card-blocking-with-date') }}" method="POST">
                ...
                <table class="table table-hover">
                  <thead class="text-warning">
                    ...
                    <tbody>
                      @foreach ($today_blocklist_by as $today_blocklist_by_item)
                      <tr>
                        <td>{{ $today_blocklist_by_item->created_by }}</td>
                        <td>{{ $today_blocklist_by_item->card_number }}</td>
                        <td>{{ $today_blocklist_by_item->chip }}</td>
                        <td>{{ $today_blocklist_by_item->created_at }}</td>
                      </tr>
                      @endforeach
                    </tbody>
                  </table>
                  ...
                  <div class="table-responsive">
                    <table class="table">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td class="text-center">{{ $profile_blocklist->id }}</td>

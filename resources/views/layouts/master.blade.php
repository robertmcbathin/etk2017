...
<body class="index-page">
   @include('includes.top_nav')
	...
	<div class="page-header header-filter clear-filter" data-parallax="active" style="background-image: url('assets/img/bg0.jpg');">
		<div class="container">
			<div class="row">
								...
								<div class="col-md-6">
									<span class="dropdown">
		                              ...
		                              <ul class="dropdown-menu dropdown-menu-right">
		                                ...
		                                <li><a href="index.html#pablo">Action</a></li>
		                                <li><a href="index.html#pablo">Another action</a></li>
		                                <li><a href="index.html#pablo">Something else here</a></li>
		                                <li class="divider"></li>
		                                <li><a href="index.html#pablo">Separated link</a></li>
		                                <li class="divider"></li>
		                                <li><a href="index.html#pablo">One more separated link</a></li>
		                              </ul>
		                            </span>
								</div>
								<div class="col-md-6">
	                    ...
	                    <nav class="navbar navbar-primary">
	                    	<div class="container-fluid">
	                            <div class="navbar-header">
	                            	...
	                            	<a class="navbar-brand" href="index.html#pablo">Menu</a>
	                            </div>

	                            <div class="collapse navbar-collapse" id="example-navbar">
	                            	<ul class="nav navbar-nav">
	                        			<li class="active"><a href="index.html#pablo">Link</a></li>
	                            		<li><a href="index.html#pablo">Link</a></li>
	                                	<li class="dropdown">
	                                		<a href="index.html#pablo" class="dropdown-toggle" data-toggle="dropdown">Dropdown
												<b class="caret"></b>
											</a>
	                                    	<ul class="dropdown-menu dropdown-menu-right">
	                                        	<li class="dropdown-header">Dropdown header</li>
	                    ...
	                    <nav class="navbar navbar-info">
	                    	<div class="container-fluid">
								<div class="navbar-header">
	                            	...
	                            	<a class="navbar-brand" href="index.html#pablo">Icons</a>
	                            </div>

	                            <div class="collapse navbar-collapse" id="example-navbar-icons">
	                            	<ul class="nav navbar-nav navbar-right">
	                        			<li>
											<a href="index.html#pablo"><i class="material-icons">email</i></a>
										</li>
	                            		<li>
											<a href="index.html#pablo"><i class="material-icons">face</i></a>
										</li>
	                                	<li class="dropdown">
	                ...
	                <nav class="navbar navbar-rose">
	                  <div class="container">
	                    ...
	                    <div class="navbar-header">
	                      ...
	                      <a class="navbar-brand" href="index.html#pablo">Brand</a>
	                    </div>
	                    ...
	                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
	                      <ul class="nav navbar-nav">
	                        <li class="active">
	    						<a href="index.html#pablo">Link</a>
	    					</li>
	                        <li>
	    						<a href="index.html#pablo">Link</a>
	    					</li>
					...
					<nav class="navbar navbar-info">
						<div class="container">
							<div class="navbar-header">
								...
								<a class="navbar-brand" href="index.html#pablo">Info Color</a>
							</div>
					...
					<nav class="navbar navbar-primary">
						<div class="container">
							<div class="navbar-header">
								...
								<a class="navbar-brand" href="index.html#pablo">Primary Color</a>
							</div>
	                ...
	                <nav class="navbar navbar-inverse" role="navigation-demo">
	                  <div class="container">
	                    ...
	                    <div class="navbar-header">
	                      ...
	                      <a class="navbar-brand" href="index.html#pablo">Navbar with notification</a>
	                    </div>
	                ...
	                <!-- Collect the nav links, forms, and other content for toggling -->
	                    <div class="collapse navbar-collapse" id="navigation-example-2">
	                      <ul class="nav navbar-nav navbar-right">
	                            ...
	                            <li>
	                                <a href="index.html#pablo" class="btn btn-rose btn-raised btn-fab btn-fab-mini" data-toggle="dropdown">
	                                    <i class="material-icons">email</i>
	                                </a>
	                            </li>
	                            <li class="dropdown">
	                                <a href="index.html#pablo" class="profile-photo dropdown-toggle" data-toggle="dropdown">
	                                ...
	                                <ul class="dropdown-menu">
	                                    ...
	                                    <li>
	                                        <a href="index.html#pablo">Me</a>
	                                    </li>
	                                    <li>
	                                        <a href="index.html#pablo">Settings and other stuff</a>
	                                    </li>
	                                    <li class="divider"></li>
	                                    <li><a href="index.html#pablo">Sign out</a></li>
	                                </ul>
	                            </li>
	                       </ul>
	                    </div><!-- /.navbar-collapse -->
	                ...
	                <nav class="navbar navbar-default" role="navigation-demo">
	                  <div class="container">
	                    ...
	                    <div class="navbar-header">
	                      ...
	                      <a class="navbar-brand" href="index.html#pablo">Navbar with profile</a>
	                    </div>
	                ...
	                <!-- Collect the nav links, forms, and other content for toggling -->
	                    <div class="collapse navbar-collapse" id="navigation-example-2">
	                      <ul class="nav navbar-nav navbar-right">
	                            ...
	                            <li>
	                                <a href="index.html#pablo" class="btn btn-rose btn-raised btn-round" data-toggle="dropdown">
	                                    Register
	                                </a>
	                            </li>
	                       </ul>
					...
					<nav class="navbar navbar-transparent">
						<div class="container">
							<div class="navbar-header">
								...
								<a class="navbar-brand" href="index.html#pablo">Transparent</a>
							</div>
									...
									<div class="nav-tabs-navigation">
										<div class="nav-tabs-wrapper">
											<ul class="nav nav-tabs" data-tabs="tabs">
												<li class="active">
													<a href="index.html#profile" data-toggle="tab">
														<i class="material-icons">face</i>
														Profile
													</a>
												</li>
												<li>
													<a href="index.html#messages" data-toggle="tab">
														<i class="material-icons">chat</i>
														Messages
													</a>
												</li>
												<li>
													<a href="index.html#settings" data-toggle="tab">
									...
									<div class="nav-tabs-navigation">
										<div class="nav-tabs-wrapper">
											<ul class="nav nav-tabs" data-tabs="tabs">
												...
												<li><a href="index.html#updates" data-toggle="tab">Updates</a></li>
												<li><a href="index.html#history" data-toggle="tab">History</a></li>
											</ul>
										</div>
									</div>
								</div>
	                ...
	                <div class="row">
	                    <div class="col-md-6">
	                        ...
	                        <ul class="nav nav-pills nav-pills-rose">
	                          <li class="active"><a href="index.html#pill1" data-toggle="tab">Profile</a></li>
	                          <li><a href="index.html#pill2" data-toggle="tab">Settings</a></li>
	                          <li><a href="index.html#pill3" data-toggle="tab">Options</a></li>
	                        </ul>
	                        ...
	                        <div class="row">
	                            <div class="col-md-4">
	                                <ul class="nav nav-pills nav-pills-rose nav-stacked">
	                                  <li class="active"><a href="index.html#tab1" data-toggle="tab">Profile</a></li>
	                                  <li><a href="index.html#tab2" data-toggle="tab">Settings</a></li>
	                                  <li><a href="index.html#tab3" data-toggle="tab">Options</a></li>
	                                </ul>
	                            </div>
	                            <div class="col-md-8">
	                ...
	                <div class="row">
	                    <div class="col-md-6">
	                        <ul class="nav nav-pills nav-pills-icons" role="tablist">
	    						...
	    						<li class="active">
	                                <a href="index.html#schedule-1" role="tab" data-toggle="tab">
	    								<i class="material-icons">schedule</i>
	    								Schedule
	                                </a>
	                            </li>
	                            <li>
	                                <a href="index.html#tasks-1" role="tab" data-toggle="tab">
	                        ...
	                        <div class="row">
	                            <div class="col-md-3">
	                                <ul class="nav nav-pills nav-pills-icons nav-stacked" role="tablist">
	                                    ...
	                                    -->
	            						<li class="active">
	            							<a href="index.html#dashboard-2" role="tab" data-toggle="tab">
	            								<i class="material-icons">dashboard</i>
	            								Dashboard
	            							</a>
	            						</li>
	            						<li >
	                                        <a href="index.html#schedule-2" role="tab" data-toggle="tab">
	            								<i class="material-icons">schedule</i>
	            								Schedule
	                                        </a>
	                                    </li>
		    ...
		    <div id="pre-footer-areas">
	        		...
	        		<div class="container">
	        			<div class="row">
	        				<div class="col-md-12">
	        					...
	        					<a href="index.html#pablo" class="btn btn-twitter btn-round">
	        						<i class="fa fa-twitter"></i> Twitter &middot; 2.5k
	        					</a>
	        					<a href="index.html#pablo" class="btn btn-facebook btn-round">
	        						<i class="fa fa-facebook-square"></i> Facebook &middot; 3.2k
	        					</a>
	        					<a href="index.html#pablo" class="btn btn-google btn-round">
	        						<i class="fa fa-google-plus"></i> Google &middot; 1.2k
	        					</a>
	        					<a href="index.html#pablo" class="btn btn-dribbble btn-round">
	        	...
	        	<div class="social-line social-line-big-icons social-line-white">
	        		<div class="container">
	        			<div class="row">
	        				...
	        				<div class="col-md-2">
	        					<a href="index.html#pablo" class="btn btn-simple btn-just-icon btn-facebook">
	        						<i class="fa fa-facebook-square"></i>
	        					</a>
	        				</div>
	        				<div class="col-md-2">
	        					<a href="index.html#pablo" class="btn btn-simple btn-just-icon btn-google">
	        						<i class="fa fa-google-plus"></i>
	        					</a>
	        				</div>
	        				<div class="col-md-2">
	        					<a href="index.html#pablo" class="btn btn-simple btn-just-icon btn-dribbble">
	        						<i class="fa fa-dribbble"></i>
	        					</a>
	        				</div>
	        				<div class="col-md-2">
	        					<a href="index.html#pablo" class="btn btn-simple btn-just-icon btn-youtube">
	        						<i class="fa fa-youtube-play"></i>
	        					</a>
	        				</div>
	        				<div class="col-md-2">
	        					<a href="index.html#pablo" class="btn btn-simple btn-just-icon btn-instagram">
	        	...
	        	<div class="social-line social-line-big-icons social-line-black">
	        		<div class="container">
	        			<div class="row">
	        				<div class="col-md-2">
	        					<a href="index.html#pablo" class="btn btn-simple btn-just-icon btn-white">
	        						<i class="fa fa-twitter"></i>
	        					</a>
	        				</div>
	        				<div class="col-md-2">
	        ...
	        <div class="section">
	    	    ...
	    	    <div id="footer-areas">
	            	...
	            	<footer class="footer footer-black">
	            		<div class="container">
	            			<a class="footer-brand" href="index.html#pablo">Material Kit PRO</a>
	            				...
	            				<div class="row">
	            					...
	            					<div class="col-md-4">
	            						...
	            						<ul class="social-buttons">
	            							<li>
	            								<a href="index.html#pablo" class="btn btn-just-icon btn-simple btn-twitter">
	            									<i class="fa fa-twitter"></i>
	            								</a>
	            							</li>
	            							<li>
	            								<a href="index.html#pablo" class="btn btn-just-icon btn-simple btn-facebook">
	            									<i class="fa fa-facebook-square"></i>
	            								</a>
	            							</li>
	            							<li>
	            								<a href="index.html#pablo" class="btn btn-just-icon btn-simple btn-dribbble">
	            									<i class="fa fa-dribbble"></i>
	            								</a>
	            							</li>
	            							<li>
	            								<a href="index.html#pablo" class="btn btn-just-icon btn-simple btn-google">
	            									<i class="fa fa-google-plus"></i>
	            								</a>
	            							</li>
	            							<li>
	            								<a href="index.html#pablo" class="btn btn-just-icon btn-simple btn-instagram">
	            									<i class="fa fa-instagram"></i>
	            								</a>
	            							</li>
	            						</ul>
	            		...
	            		<div class="container">
	            			...
	            			<div class="content">
	            				<div class="row">
	            					...
	            					<div class="col-md-3">
	            						<a href="index.html#pablo"><h5>Material Kit PRO</h5></a>
	            					...
	            					<div class="col-md-3">
	            						...
	            						<form class="form form-newsletter" method="" action="index.html">
	            			...
	            			<ul class="social-buttons">
	            				...
	            				<li>
	            					<a href="index.html#pablo" class="btn btn-just-icon btn-simple btn-youtube">
	            						<i class="fa fa-youtube-play"></i>
	            					</a>
	            				</li>
	            			</ul>
		                        ...
		                        <table class="table table-shopping">
		                            ...
		                            <tbody>
		                                <tr>
		                                    ...
		                                    <td class="td-name">
		                                        <a href="index.html#jacket">Spring Jacket</a>
		                                ...
		                                <tr>
		                                    ...
		                                    <td class="td-name">
		                                        <a href="index.html#pants">Short Pants</a>
		                                ...
		                                <tr>
		                                    ...
		                                    <td class="td-name">
		                                        <a href="index.html#nothing">Pencil Skirt</a>
		        				...
		        				<div class="media-area">
		        					...
		        					<div class="media">
		        					  ...
		        					  <div class="media-body">
		        						...
		        						<div class="media-footer">
		        							...
		        							<a href="index.html#pablo" class="btn btn-default btn-simple pull-right">
		                          ...
		                          <div class="media media-post">
		                              ...
		                              <div class="media-body">
		                                    ...
		                                    <div class="media-footer">
		                                         <a href="index.html#pablo" class="btn btn-primary btn-wd pull-right">Post Comment</a>
		                                    </div>
		                              </div>
		                          </div> <!-- end media-post -->
		                          ...
		                          <div class="media media-post">
		        	                      ...
		        	                      <div class="media-body">
		        								<form class="form">
		        		                            ...
		        		                            <div class="media-footer">
		        		                                <h6>Sign in with</h6>
		        		                                <a href="index.html" class="btn btn-just-icon btn-round btn-twitter">
		        		                                      <i class="fa fa-twitter"></i>
		        		                                </a>
		        		                                <a href="index.html" class="btn btn-just-icon btn-round btn-facebook">
		        		                                      <i class="fa fa-facebook-square"></i>
		        		                                </a>
		        		                                <a href="index.html" class="btn btn-just-icon btn-round btn-google">
		        		                                      <i class="fa fa-google-plus-square"></i>
		        		                                </a>
		        		                                <a href="index.html#pablo" class="btn btn-primary pull-right">Post Comment</a>
		        		                            </div>
		        								</form>
	    					...
	    					<div class="col-md-4">
	    						...
	    						<div class="card card-profile">
	    							...
	    							<div class="content">
	    								...
	    								<div class="footer">
	    									<a href="index.html#pablo" class="btn btn-just-icon btn-simple btn-twitter"><i class="fa fa-twitter"></i></a>
	    									<a href="index.html#pablo" class="btn btn-just-icon btn-simple btn-dribbble"><i class="fa fa-dribbble"></i></a>
	    									<a href="index.html#pablo" class="btn btn-just-icon btn-simple btn-instagram"><i class="fa fa-instagram"></i></a>
	    								</div>
	    							</div>
	    						</div>
	    					</div>
	    					...
	    					<div class="col-md-4">
	    						<div class="card card-profile">
	    							...
	    							<div class="content">
	    								...
	    								<div class="footer">
	    									<a href="index.html#pablo" class="btn btn-just-icon btn-twitter btn-round"><i class="fa fa-twitter"></i></a>
	    									<a href="index.html#pablo" class="btn btn-just-icon btn-facebook btn-round"><i class="fa fa-facebook-square"></i></a>
	    									<a href="index.html#pablo" class="btn btn-just-icon btn-google btn-round"><i class="fa fa-google"></i></a>
	    								</div>
	    							</div>
	    						</div>
	    					</div>
	    					...
	    					<div class="col-md-4">
	    						<div class="card card-profile">
	    							...
	    							<div class="content">
	    								...
	    								<a href="index.html#pablo" class="btn btn-info btn-round">Follow</a>
	    							</div>
	    						</div>
	    					</div>
	    					...
	    					<div class="col-md-6">
	    						...
	    						<div class="card card-background" style="background-image: url('assets/img/examples/office1.jpg')">
	    							...
	    							<div class="content">
	    								...
	    								<a href="index.html#pablo" class="btn btn-white btn-simple">
	    					...
	    					<div class="col-md-6">
	    						<div class="card card-background" style="background-image: url('assets/img/examples/card-blog3.jpg')">
	    							<div class="content">
	    								...
	    								<a href="index.html#pablo" class="btn btn-danger btn-round">
	    									<i class="material-icons">subject</i> Read Article
	    								</a>
	    							</div>
	    						</div>
	    					...
	    					<div class="col-md-3">
	    						<div class="card card-pricing">
	    							<div class="content">
	    								...
	    								<a href="index.html#pablo" class="btn btn-info btn-round">Choose Plan</a>
	    							</div>
	    						</div>
	    					</div>
	    					...
	    					<div class="col-md-3">
	    						<div class="card card-pricing">
	    							<div class="content content-primary">
	    								...
	    								<a href="index.html#pablo" class="btn btn-white btn-round">Choose Plan</a>
	    							</div>
	    						</div>
	    					</div>
	    					...
	    					<div class="col-md-3">
	    						<div class="card card-pricing card-background" style="background-image: url('assets/img/examples/card-blog3.jpg')">
	    							<div class="content">
	    								...
	    								<a href="index.html#pablo" class="btn btn-danger">
	    									Get Started
	    								</a>
	    							</div>
	    						</div>
	    					...
	    					<div class="col-md-3">
	    						<div class="card card-pricing">
	    							<div class="content">
	    								...
	    								<a href="index.html#pablo" class="btn btn-primary btn-round">
	    									Get Started
	    								</a>
	    							</div>
	    						</div>
	    				...
	    				<div class="row">
	    					<div class="col-md-4">
	    						...
	    						<div class="card card-blog card-plain">
	    							<div class="card-image">
	    								<a href="index.html#pablo">
	    									<img class="img" src="assets/img/examples/blog5.jpg" />
	    									<div class="card-title">
	    										This Summer Will be Awesome
	    									</div>
	    								</a>
						...
						<div class="col-md-5 col-sm-8">
							...
							<div class="fileinput fileinput-new text-center" data-provides="fileinput">
								...
								<div>
									...
									<a href="index.html#pablo" class="btn btn-danger btn-round fileinput-exists" data-dismiss="fileinput"><i class="fa fa-times"></i> Remove</a>
								</div>
							</div>
						</div>
...
<nav id="cd-vertical-nav">
	<ul>
		<li>
			<a href="index.html#buttons" data-number="1">
				<span class="cd-dot"></span>
				<span class="cd-label">Basic Elements</span>
			</a>
		</li>
		<li>
			<a href="index.html#navigation" data-number="2">
				<span class="cd-dot"></span>
				<span class="cd-label">Navigation</span>
			</a>
		</li>
		<li>
			<a href="index.html#notifications" data-number="3">
				<span class="cd-dot"></span>
				<span class="cd-label">Notifications</span>
			</a>
		</li>
		<li>
			<a href="index.html#footers" data-number="4">
				<span class="cd-dot"></span>
				<span class="cd-label">Footers</span>
			</a>
		</li>
		<li>
			<a href="index.html#typography" data-number="5">
				<span class="cd-dot"></span>
				<span class="cd-label">Typography</span>
			</a>
		</li>
		<li>
			<a href="index.html#contentAreas" data-number="6">
				<span class="cd-dot"></span>
				<span class="cd-label">Content Areas</span>
			</a>
		</li>
		<li>
			<a href="index.html#cards" data-number="7">
				<span class="cd-dot"></span>
				<span class="cd-label">Cards</span>
			</a>
		</li>
		<li>
			<a href="index.html#javascriptComponents" data-number="8">
				<span class="cd-dot"></span>

          ...
          while (($line = $reader->readLine()) !== false) {
            try {
              ...
              ->insert(['KIND' => $line[0],
               ...
               'INS_DATE' => $ins_date,
               'CPTT_ID' => $line[9],
               'CARD_SERIES_SEC' => $line[10],
               'CARD_NUM_SEC' => $line[11],
               'ID_DIVISION' => $line[12],
               'ID_TERM' => $line[13]
               ]);
              $counter++;
...
public function postFillCashback(Request $request){
  ...
  ***/
  ...
  public function getReestablishPayments(){
    $numbers = [129555834,123341119,123421971,123588943,123519844,123360286,123403170,123360051,123475383,123508548,
123348311,123613464,123523875,123416609,123603940,123572616,123407204,123407204,123386078,123411022,
123037777,123544515,123597977,123363865,123407662,123443512,123359103,123593553,123379476,123570753,
123525044,123386002,123339413,123345249,123399980,123352840,123574740,123570427,123605130,123599486,
123061005,123466879,123418359,123579406,123446950,123599778,123324783,123324987,123325346,123590709,
123324118,123324794,123459907,123362210,123475338,123475338,123378070,123378070,123349179,123343007,
123387750,123306333,123413473,123438031,123467100,123508128,123589427,123374754,123385424,123385425,
123581810,123517446,123554363,123601847,123551709,123405993,123604184,123366724,123394523,123443106,
123402687,123346429,123377973,123361946,123347329,123471474,123420617,123468712];
    $info_errors = 0;
    $payments_success = 0;
    $payments_error = 0;
    $cards = '';
